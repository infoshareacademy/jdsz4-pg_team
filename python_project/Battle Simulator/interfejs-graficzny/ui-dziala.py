...
def fight():
    ...
    while True:
        ...
        res=res+"\nRound " + str(runda) + "\n" + name_a + ' attacks with strength: ' + str(punch_a) +" " + name_b + ' attacks with strength: '+ str(punch_b)+' '+ name_a+ ' HP: '+ str(hp_a)+ " " + name_b+ ' HP: '+ str(hp_b)
...
results = Label(frame1, font=("Comic Sans", 22),background="azure")
results.grid(row=2)
